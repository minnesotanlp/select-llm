...
DATA_PATH = os.path.join('./datasets/data/', cross_dataset) 
...
if sample_type=='infoverse' or sample_type == 'selectllm':
    SAVE_TEST_FILE = f'{sample_type}_{ftype}_{n_instances}{formattype}{det_str}_rs_{random_state}_{cross_dataset}.json' 
else:
    SAVE_TEST_FILE = f'{sample_type}_{n_instances}{formattype}{det_str}_rs_{random_state}_{cross_dataset}.json'
