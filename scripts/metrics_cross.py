...
class Preprocess():
    def __init__(self):
        ...
        self.output_dir = "/corpora/llama/llama_2_hf/Instructllama-2-7b/"
        self.model_path = "/corpora/llama/llama_2_hf/llama-2-7b/7bweights"
...
if __name__=='__main__':
    ...
    parser.add_argument('--cross_dataset', help='no. of instances')
    ...
    if args.ftype:
        preds_rs1 = preds_dir + f'{sample_type}_{args.ftype}_{n_instances}_formatted_det_rs_2021_{cross_dataset}.json'
        ...
        preds_rs1 = preds_dir + f'{sample_type}_{n_instances}_formatted_det_rs_2021_{cross_dataset}.json'
    ...
    gts_path = f'../datasets/data/{cross_dataset}/test_gts.json'
    ...
    # camel_rouge_l_mean = (camel_rouge_l_mean1 + camel_rouge_l_mean2)/2.0 #+ camel_rouge_l_mean3)/3.0
    # camel_cossims_mean = (camel_cossims_mean1 + camel_cossims_mean2)/2.0 # + camel_cossims_mean3)/3.0
    # camel_perp         = (camel_perp1 + camel_perp2/2.0)# + camel_perp3)/3.0
